...
3. `validate` executes the bundled byte-for-byte copy of the published Draft
   2020-12 JSON Schema, then confirms that the reported subject and value occur
   in the anchored evidence. A test prevents the bundled and published schema
